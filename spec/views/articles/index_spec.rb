...
RSpec.describe "articles/index.html.erb", type: :view do
  ...
  it "displays the blogs list" do
    render

    expect(rendered).to have_content("Blogs list")
    expect(rendered).to have_selector("div.container")
    expect(rendered).to have_selector("h1.text-center", text: "Blogs list")
    ...
    expect(rendered).to have_link("View All Blogs", href: articles_path, class: "btn btn-light")
